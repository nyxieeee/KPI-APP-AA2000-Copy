...
const SalesSupervisorDashboard: React.FC<Props> = ({ 
      ...
      <div className="bg-slate-100 rounded-xl p-5 border border-slate-200 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className={`text-[9px] font-bold uppercase tracking-wide mb-4 ${queueTab === 'pending' ? 'text-blue-600/90' : 'text-slate-500'}`}>Sales Department</p>
          ...
          >
            ...
            <p className={`text-[9px] font-bold uppercase tracking-wide mb-4 ${queueTab === 'history' ? 'text-blue-600/90' : 'text-slate-500'}`}>Sales Department</p>
            <div className="relative flex items-center justify-center w-40 h-40">
              <svg className="w-full h-full -rotate-90" viewBox="0 0 100 100">
                <circle cx="50" cy="50" r="42" fill="none" stroke="rgb(226 232 240)" strokeWidth="10" />
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <span className={`text-[9px] font-bold uppercase tracking-wide mt-1 ${queueTab === 'history' ? 'text-blue-600' : 'text-slate-400'}`}>validated</span>
              </div>
            </div>
          </button>
          <button
          ...
          >
            ...
            <p className={`text-[9px] font-bold uppercase tracking-wide mb-4 ${queueTab === 'rejected' ? 'text-red-600/90' : 'text-slate-500'}`}>Sales Department</p>
            <div className="relative flex items-center justify-center w-40 h-40">
              <svg className="w-full h-full -rotate-90" viewBox="0 0 100 100">
                <circle cx="50" cy="50" r="42" fill="none" stroke="rgb(226 232 240)" strokeWidth="10" />
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-lg border border-slate-100 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="text-base font-black text-slate-900 tracking-tight">Sales Team Matrix</h3>
        ...
        <div className="bg-slate-100 rounded-xl p-5 border border-slate-200 shadow-sm">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            <div>
              ...
              <h2 className="mt-1 text-xl font-black text-slate-900 tracking-tight uppercase">Sales Incentives</h2>
      ...
      <div className="w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden pb-12">
          <div className="p-5 border-b border-slate-50 flex items-center justify-between bg-slate-50/50">
            ...
            {!isReadOnly && (
               <div className={`px-4 py-2 rounded-xl border text-[9px] font-black uppercase tracking-wide flex items-center gap-2 ${calculatedScore.incentivePct >= 1 ? 'bg-blue-50 text-blue-600 border-blue-100 animate-pulse' : 'bg-blue-50 text-blue-600 border-blue-100'}`}>
  ...
  return (
    <div className="w-full flex flex-col px-4 sm:px-6 md:px-8 lg:px-12 pb-6 md:pb-12">
      ...
      >
        <div>
          <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight leading-none">Sales Supervisor</h1>
        </div>
